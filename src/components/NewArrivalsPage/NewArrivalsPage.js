                    ...
                    if (true) {
                      ...
                      return (
                        ...
                        <div className={Styles.cardElement}>
                          ...
                          {(!isNaN(salesPrice)&&!isNaN(listPrice)) ?salesPrice != listPrice ?
                          
                        
                          <div className={Styles.priceCrossed}> {listPrice ==null ? null : <>${listPrice?.toFixed(2)}</> } </div>
                          
                          
                          
                          :ProductInCart?<div className={Styles.priceCrossed}>${listPrice?.toFixed(2)}</div>:null:null}
                          &nbsp;
                          {listPrice ===null  ? '$NA' :  
